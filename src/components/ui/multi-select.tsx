  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "relative min-h-[38px] rounded-lg placeholder:text-text-secondary border border-border-primary text-sm transition-shadow focus-within:border-border-brand focus-within:outline-none focus-within:ring-[2px] focus-within:ring-border-brand has-[:disabled]:cursor-not-allowed has-[:disabled]:opacity-50",
            {
        ...
        >
          <div className="flex flex-wrap gap-1">
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                "flex-1 bg-transparent outline-none placeholder:text-text-secondary disabled:cursor-not-allowed",
                {
        ...
        <div className="relative">
          ...
          >
            {open && (
              ...
              >
                {Object.entries(selectables).length === 0 && loading ? (
                  <>{loadingIndicator}</>
                ) : (
                  <>
                    {EmptyItem()}
